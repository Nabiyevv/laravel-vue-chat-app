...
const props = defineProps(['otherUser']);
...
const sendMessage = () => {
    requestBody.receiver_id = props.otherUser;
    if (message.value != '') {
        console.log(message.value);
        axiosClient.post(`/api/send-message`, requestBody)
            .then(data => {
...
<template>
    <div class="border-t-2 border-gray-200 px-4 pt-2 mb-2 sm:mb-0">
        <div class="relative flex">
            ...
            <input v-on:keyup.enter="sendMessage" v-model="message" type="text" placeholder="Write your message!"
